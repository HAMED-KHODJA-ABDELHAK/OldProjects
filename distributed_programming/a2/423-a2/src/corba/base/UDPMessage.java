...
public class UDPMessage {
	...
	public static UDPMessage joinPoolRequest(ServerAddress addr) {
		UDPMessage m = new UDPMessage(CMD_JOIN_POOL_REQ);
	...
	public static UDPMessage joinPoolReply(Collection<ServerAddress> addrList) {
		UDPMessage m = new UDPMessage(CMD_JOIN_POOL_REPLY);
	...
	public static UDPMessage stockRequest(int itemID) {
		UDPMessage m = new UDPMessage(CMD_GET_STOCK_REQ);
	...
	public static UDPMessage stockReply(int itemID, int stock, String storeName) {
		UDPMessage m = new UDPMessage(CMD_GET_STOCK_REPLY);
	...
	public static UDPMessage numSoldRequest(int itemID, String cID) {
		UDPMessage m = new UDPMessage(CMD_NUM_SOLD_REQ);
	...
	public static UDPMessage numSoldReply(int itemID, int numSold, String cID) {
		UDPMessage m = new UDPMessage(CMD_NUM_SOLD_REPLY);
	...
	public static UDPMessage nearestServerRequest(String cID) {
		UDPMessage m = new UDPMessage(CMD_NEAR_SERVER_REQ);
	...
	public static UDPMessage nearestServerReply(String cID, String serverName) {
		UDPMessage m = new UDPMessage(CMD_NEAR_SERVER_REPLY);
	...
	public void parseBytes() throws IOException {
		...
		rest = rest.substring(0, rest.lastIndexOf(UDPMessage.END_MESSAGE));
